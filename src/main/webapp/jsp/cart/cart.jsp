...
<!DOCTYPE html> <html> <head> <meta charset="UTF-8"> <title>Корзина</title>  <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/cart.css">
    ...
    <button disabled>Купить</button> </c:when> <c:otherwise>
    <p>Корзина пуста</p> </c:otherwise> </c:choose> <p><a href="${pageContext.request.contextPath}/orders">← Назад к товарам</a></p> </body> </html>